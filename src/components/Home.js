           ...
           <div className="homeDiv" id="home">
            ...
            <div className="grid2">
                <div>
                    ...
                    {/* <h1> </h1>
                    <h1 className=" headText fader line-1 anim-typewriter">I am John Alalade</h1> */}
  ...
  <span
     ...
     data-rotate='[ " a Developer", " a Designer", " a Creator", " an Expert" ]'></span>
                    ...
                    <span className="bottomFader">
                        <a target="_blank" rel="noreferrer" className="homeSocIcon" href="https://github.com/johna" title="Github"><i className="fab fa-github "></i></a>
                        <a target="_blank" rel="noreferrer" className="homeSocIcon" href="https://facebook.com/alalade.johna" title="Facebook"><i className="fab fa-codepen "></i></a>
                        <a target="_blank" rel="noreferrer" className="homeSocIcon" href="https://linkedin.com/alalade-john" title="LinkedIn"><i className="fab fa-linkedin "></i></a>
                        <a target="_blank" rel="noreferrer" className="homeSocIcon" href="https://twitter.com/johna" title="Twitter"><i className="fab fa-twitter "></i></a>
